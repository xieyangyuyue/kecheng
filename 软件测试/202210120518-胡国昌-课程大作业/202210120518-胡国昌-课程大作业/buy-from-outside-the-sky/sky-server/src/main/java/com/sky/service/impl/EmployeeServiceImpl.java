...
public class EmployeeServiceImpl implements EmployeeService {
     ...
     */
    @Override
    public void insert(EmployeeDTO employeeLoginDTO) {
...
//从当前线程获取操作员工id
     ...
     */
    @Override
    public PageResult limit(EmployeePageQueryDTO employeePageQueryDTO) {
//        设置分页参数
        PageHelper.startPage(employeePageQueryDTO.getPage(), employeePageQueryDTO.getPageSize());
//        获取总记录数和具体员工数据
        Page<Employee> employees = employeeMapper.pageQuery(employeePageQueryDTO.getName());
        long total = employees.getTotal();
        List<Employee> emp = employees.getResult();
